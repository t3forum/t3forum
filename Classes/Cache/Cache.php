<?php
namespace T3forum\T3forum\Cache;
    ...
    public function initializeObject()
    {
        try {
            ...
            $this->cacheInstance = $this->cacheFactory->create(
                self::CACHE_NAME,
                $GLOBALS['TYPO3_CONF_VARS']['SYS']['caching']['cacheConfigurations']['t3forum_main']['frontend'],
                $GLOBALS['TYPO3_CONF_VARS']['SYS']['caching']['cacheConfigurations']['t3forum_main']['backend'],
                $GLOBALS['TYPO3_CONF_VARS']['SYS']['caching']['cacheConfigurations']['t3forum_main']['options']
            );
        }
    }

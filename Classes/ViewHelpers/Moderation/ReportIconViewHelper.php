<?php
namespace T3forum\T3forum\ViewHelpers\Moderation;
...
class ReportIconViewHelper extends AbstractViewHelper
{
     ...
     *
     */
    const TYPOSCRIPT_PATH = 'plugin.tx_t3forum.renderer.icons.report';
     ...
     *
     * @param Report $report The report for which the icon is to be rendered.

...
class BigButtonViewHelper extends ActionViewHelper
{
     ...
     * @var string
     */
    protected $iconBaseClass = 'tx-t3forum-icon-32-';
    ...
    {
        parent::initialize();
        $this->tag->addAttribute('class', 'tx-t3forum-button-big');
    }
    ...
    public function renderChildren()
    {
        ...
        if ($iconClass) {
            $cssClass = 'tx-t3forum-button-text';
            $content = '<div class="' . $iconClass . '"></div><div class="' . $cssClass . '">' . $content . '</div>';
        }
        return $content;
    }
}

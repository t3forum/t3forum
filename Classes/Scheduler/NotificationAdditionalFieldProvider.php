...
class NotificationAdditionalFieldProvider implements AdditionalFieldProviderInterface
{
    ...
    public function getAdditionalFields(array &$taskInfo, $task, SchedulerModuleController $schedulerModule)
    {
        ...
        $additionalFields['Notification_forumPids'] = [
            ...
            'label' => 'LLL:EXT:t3forum/Resources/Private/Language/locallang.xml:tx_t3forum_scheduler_notification_forumPid',
            'cshKey' => '',
            'cshLabel' => ''
        ];
        ...
        $additionalFields['Notification_userPids'] = [
            ...
            'label' => 'LLL:EXT:t3forum/Resources/Private/Language/locallang.xml:tx_t3forum_scheduler_notification_userPid',
            'cshKey' => '',
            'cshLabel' => ''
        ];
        ...
        $additionalFields['Notification_notificationPid'] = [
            ...
            'label' => 'LLL:EXT:t3forum/Resources/Private/Language/locallang.xml:tx_t3forum_scheduler_notification_notificationPid',
            'cshKey' => '',
            'cshLabel' => ''
        ];

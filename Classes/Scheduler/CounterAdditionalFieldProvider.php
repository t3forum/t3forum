...
class CounterAdditionalFieldProvider implements AdditionalFieldProviderInterface
{
    ...
    public function getAdditionalFields(array &$taskInfo, $task, SchedulerModuleController $schedulerModule)
    {
        ...
        $additionalFields['Counter_forumPid'] = [
            ...
            'label' => 'LLL:EXT:t3forum/Resources/Private/Language/locallang.xml:tx_t3forum_scheduler_counter_forumPid',
            'cshKey' => '',
            'cshLabel' => '',
        ];
        ...
        $additionalFields['Counter_userPid'] = [
            ...
            'label' => 'LLL:EXT:t3forum/Resources/Private/Language/locallang.xml:tx_t3forum_scheduler_counter_userPid',
            'cshKey' => '',
            'cshLabel' => '',
        ];

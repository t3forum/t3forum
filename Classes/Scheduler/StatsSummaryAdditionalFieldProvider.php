...
class StatsSummaryAdditionalFieldProvider implements AdditionalFieldProviderInterface
{
    ...
    public function getAdditionalFields(array &$taskInfo, $task, SchedulerModuleController $schedulerModule)
    {
        ...
        $additionalFields['StatsSummary_forumPids'] = [
            ...
            'label' => 'LLL:EXT:t3forum/Resources/Private/Language/locallang.xml:tx_t3forum_scheduler_statsSummary_forumPid',
            'cshKey' => '',
            'cshLabel' => ''
        ];
        ...
        $additionalFields['StatsSummary_userPids'] = [
            ...
            'label' => 'LLL:EXT:t3forum/Resources/Private/Language/locallang.xml:tx_t3forum_scheduler_statsSummary_userPid',
            'cshKey' => '',
            'cshLabel' => ''
        ];
        ...
        $additionalFields['StatsSummary_statsPid'] = [
            ...
            'label' => 'LLL:EXT:t3forum/Resources/Private/Language/locallang.xml:tx_t3forum_scheduler_statsSummary_statsPid',
            'cshKey' => '',
            'cshLabel' => ''
        ];
